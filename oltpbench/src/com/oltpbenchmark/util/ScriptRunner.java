...
public class ScriptRunner {
	 ...
	 * Default constructor
	 */
	public ScriptRunner(DBConnect connection, boolean autoCommit,
			boolean stopOnError) {
	 ...
	 */
	private void runScript(DBConnect conn, Reader reader) throws IOException,
			SQLException {
		...
		try {
			...
			while ((line = lineReader.readLine()) != null) {
				...
				if (trimmedLine.startsWith("--")) {
					...
					// HACK
					if (hasResults
							&& sql.toUpperCase().startsWith("CREATE") == false) {
