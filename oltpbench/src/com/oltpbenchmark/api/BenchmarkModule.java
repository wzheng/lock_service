...
public abstract class BenchmarkModule {
    ...
    private DBConnect last_connection;
     ...
     *             TODO
     */
    protected abstract Loader makeLoaderImpl(DBConnect conn) throws SQLException;
     ...
     * @param conn
     */
    protected final void loadDatabase(DBConnect conn) {
        try {
     ...
     * @return
     */
    protected final boolean executeFile(DBConnect c, File path) {
