...
public class RPC {
    ...
    public RPC(String serverName, int port) {
		...
		try {
	            ...
	            System.err.println("Couldn't get I/O for the connection to server " + serverName);
	            System.exit(1);
	        }
    }
    ...
    public void send(ServerAddress sa, String methodName, String uid, List<Object> args) {
