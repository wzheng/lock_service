...
public class Worker implements Runnable {
    ...
    public void startTransaction(RPCRequest rpcReq) {
        ...
        if (this.server.getServerAddress().equals(tid.getServerAddress())) {
            ...
            while (it.hasNext()) {
                ...
                ServerAddress sa = this.server
                        .getServerAddress((int) it.next());
            ...
            RPC.send(rpcReq.replyAddress, "start-reply", "001",
                    newReq.toJSONObject());
            readSet.clear();
        }
    ...
    public void abort(RPCRequest rpcReq) {
        ...
        if (this.server.getServerAddress().equals(tid.getServerAddress())) {
            ...
            while (it.hasNext()) {
                ...
                HashMap<String, Object> args = new HashMap<String, Object>();
                ServerAddress thisSA = this.server.getAddress();
                RPCRequest newReq = new RPCRequest("abort", sa, rpcReq.tid,
                        args);
            ...
            RPCRequest newReq = new RPCRequest("abort-reply", sa, rpcReq.tid,
                    args);
            RPC.send(rpcReq.getReplyAddress(), "abort-reply", "001",
                    newReq.toJSONObject());
        }
    }
    ...
    public void commit(RPCRequest rpcReq) {
        ...
        if (this.server.getServerAddress().equals(
                this.txn.tid.getServerAddress())) {
            ...
            while (it.hasNext()) {
                ...
                HashMap<String, Object> args = new HashMap<String, Object>();
                ServerAddress thisSA = this.server.getAddress();
                RPCRequest newReq = new RPCRequest("commit", sa, rpcReq.tid,
                        args);
            ...
            args.put("State", true);
            RPCRequest newReq = new RPCRequest("commit-reply", sa, rpcReq.tid,
                    args);

            RPC.send(rpcReq.getReplyAddress(), "commit-reply", "001",
                    newReq.toJSONObject());
        }
    }
